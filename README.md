...
2- Import the package into app root module
```javascript
import FlutterwaveModule from "flutterwaveV3Angular"
...
3- Use the 'MakePaymentComponent' to accept payment 
```javascript
...
OR Pass in object containing the payment options
...
<flutterwave-make-payment
  ...
  amount: 9000,
      ...
      customer : {
        name: 'Demo2 Customer2  Name2',
        email: 'customer2@mail.com',
        phone_number: '081845***'
      },
      customizations: {
        title: 'Customization Title' , description: 'Customization Description'  , logo : 'https://flutterwave.com/images/logo-colored.svg'
      } ,
...
## Flutterwave Components and  Services exposed by the library

**1**.  **CHARGE**
  * 'MakePaymentComponent' using
  * Card
